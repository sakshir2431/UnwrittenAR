    ...
    <div className="card" style={{ display: "grid", gap: 12 }}>
      ...
      {isRecording && (
        <div className="row" style={{ alignItems: "center", gap: 8 }}>
          <span className="badge">⏱ {seconds}s {isPaused ? "paused" : "recording"}…</span>
          {!isPaused ? (
            <button onClick={pause} className="ghost">⏸ Pause</button>
          ) : (
            <button onClick={resume} className="ghost">▶️ Resume</button>
          )}
          <button onClick={stop} className="warn">⏹ Stop</button>
        </div>
      )}
      ...
      {!isRecording && blobUrl && (
        <div className="row" style={{ gap: 8 }}>
          ...
          <button onClick={download} className="ghost">⬇️ Download</button>
